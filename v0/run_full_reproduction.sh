...
PY=/root/autodl-tmp/.conda/envs/pro1/bin/python
LOG=/root/autodl-tmp/personal_ppg2ecg/logs
...
$PY -u model/cardioalign_encoder/train.py \
    ...
    --save_dir /root/autodl-tmp/personal_ppg2ecg/results/cardioalign_encoder > "$LOG/train_vae.log" 2>&1
...
$PY -u model/Individual_base_extractor/train.py \
    ...
    --save_dir /root/autodl-tmp/personal_ppg2ecg/results/IBExtractor > "$LOG/train_ibe.log" 2>&1
