...
import time
import torch
from personal_ppg2ecg.v0.utils.io_utils import write_args, save_config_to_yaml
import tensorboardX
...
class Logger(object):
    def __init__(self, args):
        ...
        if args.tensorboard:
            ...
            self.tb_writer = tensorboardX.SummaryWriter(log_dir=log_dir) # tensorboard.SummaryWriter(log_dir=log_dir)
        else:
            self.tb_writer = None
