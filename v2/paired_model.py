...
from personal_ppg2ecg.v2.metrics import zscore_tensor
...
def paired_objective(point, scale, target):
    ...
    return {'loss': mse + 0.5 * mae + 0.1 * slope + 0.05 * nll,
            'mae': mae, 'mse': mse, 'slope': slope, 'nll': nll}
